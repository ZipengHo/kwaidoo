...
public class CommonServlet extends DefaultServlet{
	...
	public final static String LOG = CommonServlet.class.getSimpleName();
...
//		tracer.info(LOG, "accept = " + accept);
//		if(!CmnUtil.isStringEmpty(accept) && accept.toLowerCase().equals(MediaType.TEXT_EVENT_STREAM_VALUE)) {
//			tracer.info(LOG, "path = " + path+",消息流请求，转发到/events");
