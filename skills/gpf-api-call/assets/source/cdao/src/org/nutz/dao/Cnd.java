...
import org.nutz.dao.util.cri.OrderByItem;
...
public class Cnd implements OrderBy, Criteria, GroupBy {
    ...
    public OrderBy ascNullsLast(String name) {
    	OrderBySet orderBy = cri.getOrderBy();
        orderBy.getItems().add(new OrderByItem(name,"asc nulls last"));
        return this;
    }
    ...
    public OrderBy descNullsLast(String name) {
    	OrderBySet orderBy = cri.getOrderBy();
        orderBy.getItems().add(new OrderByItem(name,"desc nulls last"));
        return this;
    }
    ...
    public OrderBy orderBy(OrderByItem orderBy) {
    	OrderBySet orderBySet = cri.getOrderBy();
    	orderBySet.getItems().add(orderBy);
        return this;
    }
    ...
    // CK
    public Cnd andIsBlankString(String name)
    {
        return and(Cnd.exps(name, "=", null).orIsNull(name).or(name, "=", ""));
    }
